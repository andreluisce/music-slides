-- Apenas NOVAS tabelas - Execute este SQL se já rodou o supabase-schema.sql antes
...
-- ==================================
-- SLIDES PERSONALIZADOS (precisa criar antes de presentation_items)
-- ==================================
...
CREATE POLICY "Enable all for presentations" ON presentations FOR ALL USING (true);
CREATE POLICY "Enable all for presentation_items" ON presentation_items FOR ALL USING (true);
CREATE POLICY "Enable all for custom_slides" ON custom_slides FOR ALL USING (true);
CREATE POLICY "Enable all for tags" ON tags FOR ALL USING (true);
CREATE POLICY "Enable all for song_tags" ON song_tags FOR ALL USING (true);
CREATE POLICY "Enable all for favorites" ON favorites FOR ALL USING (true);
CREATE POLICY "Enable all for presentation_history" ON presentation_history FOR ALL USING (true);
